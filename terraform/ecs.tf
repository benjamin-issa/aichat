  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "MONGO_URI", value = "mongodb://${var.documentdb_master_username}:${var.documentdb_master_password}@${aws_docdb_cluster.librechat.endpoint}:27017/librechat?ssl=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false&tlsAllowInvalidCertificates=true" },
